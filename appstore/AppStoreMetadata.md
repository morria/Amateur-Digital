...
- QPSK63 (62.5 Baud) — Fastest PSK variant for excellent conditions

MULTI-CHANNEL DECODING
Monitor multiple signals simultaneously across the audio passband. The app automatically detects and decodes transmissions on different frequencies, displaying each conversation in its own channel.
...
ICLOUD SYNC
Your callsign, grid locator, and mode settings sync across all your devices via iCloud.

FREE AND OPEN SOURCE
No ads, no in-app purchases, no subscriptions, no tracking. Amateur Digital is open source and built by a ham for hams.

REQUIREMENTS
- iPhone or iPad running iOS 17 or later
- USB audio interface (Lightning or USB-C)
- HF transceiver with SSB (USB) capability
