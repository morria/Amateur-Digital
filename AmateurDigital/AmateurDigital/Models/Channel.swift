...
struct Channel: Identifiable, Equatable, Hashable {
    ...
    var cwWPM: Double            // Per-channel CW speed in WPM (5-45)
    var cwToneFrequency: Double  // Per-channel CW tone frequency in Hz
    ...
    init(
        ...
        self.cwWPM = cwWPM
        self.cwToneFrequency = cwToneFrequency
